...
url_base = data_confing.get('url_backend-academic') + "/result"
...
@results_blueprints.route("/result/<string:id_>", methods=['GET'])
...
@results_blueprints.route("/result/insert", methods=['POST'])
...
@results_blueprints.route("/result/update/<string:id_>", methods=['PUT'])
...
@results_blueprints.route("/result/delete/<string:id_>", methods=['DELETE'])
